...
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY=y
# CONFIG_BOARD_SOURCE_BOARD_ST_NUCLEO_F401RE_ST_NUCLEO_F401RE is not set
# CONFIG_BOARD_SOURCE_BOARD_ST_NUCLEO_F429ZI_ST_NUCLEO_F429ZI is not set
# CONFIG_BOARD_SOURCE_BOARD_ST_NUCLEO_F446RE_ST_NUCLEO_F446RE is not set
# CONFIG_BOARD_SOURCE_BOARD_ST_STM32F4DISCOVERY_ST_STM32F4DISCOVERY is not set
...
CONFIG_BOARD_INCLUDES="source/board/ST_32F429IDISCOVERY/include"
CONFIG_BOARD="ST,32F429IDISCOVERY"

#
# ST,32F429IDISCOVERY linker script options
#
CONFIG_LDSCRIPT="source/board/ST_32F429IDISCOVERY/ST_32F429IDISCOVERY.ld"
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_TEXT_VECTORS_REGION_FLASH=y
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_TEXT_REGION_FLASH=y
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_ARM_EXIDX_REGION_FLASH=y
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_MAIN_STACK_REGION_SRAM=y
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_MAIN_STACK_REGION_CCM is not set
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_BSS_REGION_SRAM=y
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_BSS_REGION_CCM is not set
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_DATA_VMA_REGION_SRAM=y
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_DATA_VMA_REGION_CCM is not set
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_DATA_LMA_REGION_FLASH=y
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_NOINIT_REGION_SRAM=y
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_NOINIT_REGION_CCM is not set
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_NOINIT_REGION_BKPSRAM is not set
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_SRAM_DATA_LMA_REGION_FLASH=y
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_CCM_DATA_LMA_REGION_FLASH=y
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_PROCESS_STACK_REGION_SRAM=y
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_PROCESS_STACK_REGION_CCM is not set
CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_HEAP_REGION_SRAM=y
# CONFIG_BOARD_SOURCE_BOARD_ST_32F429IDISCOVERY_ST_32F429IDISCOVERY_LD_HEAP_REGION_CCM is not set

#
# ST,32F429IDISCOVERY buttons options
#
CONFIG_BOARD_BUTTONS_ENABLE=y
CONFIG_BOARD_BUTTONS_B1_ENABLE=y

#
# ST,32F429IDISCOVERY displayOutputs options
#
CONFIG_BOARD_DISPLAYOUTPUTS_ENABLE=y
CONFIG_BOARD_DISPLAYOUTPUTS_SPICSX_ENABLE=y
CONFIG_BOARD_DISPLAYOUTPUTS_RDX_ENABLE=y
CONFIG_BOARD_DISPLAYOUTPUTS_TE_ENABLE=y
CONFIG_BOARD_DISPLAYOUTPUTS_WRXDCX_ENABLE=y

#
# ST,32F429IDISCOVERY displayPinmux options
#
CONFIG_BOARD_DISPLAYPINMUX_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTVSYNC_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTHSYNC_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTDE_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTCLK_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTR2_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTR3_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTR4_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTR5_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTR6_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTR7_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTG2_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTG3_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTG4_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTG5_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTG6_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTG7_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTB2_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTB3_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTB4_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTB5_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTB6_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_TFTB7_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_SPISCK_ENABLE=y
CONFIG_BOARD_DISPLAYPINMUX_SPIMOSI_ENABLE=y

#
# ST,32F429IDISCOVERY leds options
#
CONFIG_BOARD_LEDS_ENABLE=y
CONFIG_BOARD_LEDS_LD3_ENABLE=y
CONFIG_BOARD_LEDS_LD4_ENABLE=y
CONFIG_BOARD_HAS_YAML=y
CONFIG_CHIP_ROM_SIZE=2097152
CONFIG_CHIP_ROM_ADDRESS=0x08000000
CONFIG_CHIP="STM32F429ZI"
CONFIG_CHIP_INCLUDES="source/chip/STM32/include source/chip/STM32/STM32F4/include source/chip/STM32/peripherals/GPIOv2/include source/chip/STM32/peripherals/SPIv1/include source/chip/STM32/peripherals/USARTv1/include source/chip/STM32/peripherals/LTDCv1/include source/chip/STM32/STM32F4/external/CMSIS-STM32F4"
...
CONFIG_CHIP_STM32F4_RCC_PLLSAI_ENABLE=y
CONFIG_CHIP_STM32F4_RCC_PLLSAIN=96
CONFIG_CHIP_STM32F4_RCC_LCD_ENABLE=y
CONFIG_CHIP_STM32F4_RCC_PLLSAIR=4
# CONFIG_CHIP_STM32F4_RCC_PLLSAI_DIV2 is not set
# CONFIG_CHIP_STM32F4_RCC_PLLSAI_DIV4 is not set
CONFIG_CHIP_STM32F4_RCC_PLLSAI_DIV8=y
# CONFIG_CHIP_STM32F4_RCC_PLLSAI_DIV16 is not set
...
CONFIG_CHIP_STM32F4_RCC_PLLSAIDIVR=8

#
# Peripherals configuration
#
CONFIG_CHIP_STM32_GPIO_V2_GPIOA_ENABLE=y
CONFIG_CHIP_STM32_GPIO_V2_GPIOB_ENABLE=y
CONFIG_CHIP_STM32_GPIO_V2_GPIOC_ENABLE=y
CONFIG_CHIP_STM32_GPIO_V2_GPIOD_ENABLE=y
# CONFIG_CHIP_STM32_GPIO_V2_GPIOE_ENABLE is not set
CONFIG_CHIP_STM32_GPIO_V2_GPIOF_ENABLE=y
CONFIG_CHIP_STM32_GPIO_V2_GPIOG_ENABLE=y
...
CONFIG_CHIP_STM32_LTDCV1=y
CONFIG_CHIP_STM32_LTDCV1_ENABLE=y
CONFIG_CHIP_STM32_LTDCV1_HAS_LTDC=y
...
CONFIG_CHIP_STM32_SPIV1_SPI5_ENABLE=y
# CONFIG_CHIP_STM32_SPIV1_SPI6_ENABLE is not set
...
CONFIG_CHIP_STM32_SPIV1_HAS_SPI5=y
CONFIG_CHIP_STM32_SPIV1_HAS_SPI6=y
...
# CONFIG_CHIP_STM32_USARTV1_UART7_ENABLE is not set
# CONFIG_CHIP_STM32_USARTV1_UART8_ENABLE is not set
...
CONFIG_CHIP_STM32_USARTV1_HAS_UART7=y
CONFIG_CHIP_STM32_USARTV1_HAS_UART8=y
...
# main() thread options
#
CONFIG_MAIN_THREAD_STACK_SIZE=8192
...
CONFIG_PLANESOPERATIONS_ENABLE=y
...
CONFIG_LDSCRIPT_ROM_END=2097152
